...
public interface IOtpService
{
    ...
    /// </summary>
    Task<ServiceResult<string>> GenerateOtpAsync(string identifier, OtpType type);
    ...
    /// not expired.
    /// </summary>
    Task<ServiceResult<bool>> ValidateOtpAsync(string identifier, OtpType otpType, string otpCode);
}
